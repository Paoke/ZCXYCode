    ...
    <body>
        <article class="page-container">
            <form class="form form-horizontal" id="form-article-add">
                <input type="hidden" id="caid" name="caid" value="<?php echo ($arrArticle["caid"]); ?>">
                ...
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-2"><span class="c-red">* </span>主讲人：</label>
                    <div class="formControls col-xs-8 col-sm-5">
                        <input type="text" class="input-text" value="<?php echo ($arrArticle["speaker"]); ?>" placeholder="" id="speaker" name="speaker">
                    </div>
                </div>
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-2"><span class="c-red">* </span>主讲人职位：</label>
                    <div class="formControls col-xs-8 col-sm-5">
                        <input type="text" class="input-text" value="<?php echo ($arrArticle["job"]); ?>" placeholder="" id="job" name="job">
                    </div>
                </div>
                <div class="row cl">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-5">
                        <input type="text" class="input-text" value="<?php echo ($arrArticle["position"]); ?>" placeholder="" id="position" name="position"><span class="c-red">(例如：广州)</span>
                    </div>
                </div>
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-5">
                        <input type="file" class="thumbimg" name="thumbimg" onchange="upload('thumbimg')"><span class="c-red" id="success">(图片规格：320*216)</span>
        ...
        <script type="text/javascript">
            ...
            $('#btn_submit').on('click', function () {
                ...
                if(data.title==""||data.speaker==""||data.author==""||data.from==""||data.job==""||data.position==""||data.time==""||data.thumbimg_position==""||data.content==""){
                    layer.msg('请把资料填完整', {icon: 7, time: 2000});
                    return false;
                }
                var caid=$('#caid').val();
                $.post("/index.php/Admin/Case/editArticle?caid="+caid, data, function (ret) {
                    if (ret== 'true') {
