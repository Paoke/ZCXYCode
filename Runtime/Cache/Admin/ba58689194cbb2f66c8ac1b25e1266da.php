    ...
    <body>
        <article class="page-container">
            <form action="" method="post" class="form form-horizontal" id="form-member-add">
                <input type="hidden" id="header_position" name="header_position">
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>姓名：</label>
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" value="" placeholder="请输入嘉宾姓名" id="name" name="name">
                    </div>
                </div>
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>职位：</label>
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" value="" placeholder="请输入嘉宾职位" id="job" name="job">
                    </div>
                </div>
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        ...
                        <br/><br/><img src="" style="width:204px;height:204px;" id="header_see">
        ...
        <script>
            $('#btn_submit').on('click', function () {
                ...
                $.post('/index.php/Admin/Student/addMember', data, function (ret) {
                    if (ret == 'true') {
