    ...
    <body>
        <article class="page-container">
            <form class="form form-horizontal" id="form-article-add">
                <input type="hidden" id="abid" name="abid" value="<?php echo ($arrData["abid"]); ?>">
                <input type="hidden" id="content" name="content">
                <input type="hidden" id="banner_position" name="banner_position" value="<?php echo ($arrData["banner"]); ?>">
                <div class="row cl">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" value="<?php echo ($arrData["introduce"]); ?>" placeholder="请输入介绍" id="introduce" name="introduce">
                    </div>
                </div>
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-2"><span class="c-red">* </span>banner图：</label>
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="file" class="banner" name="banner" onchange="upload('banner')"><span class="c-red" id="header_success">(图片规格：1920*360)</span>
                        <br/><br/><img src="/Upload/<?php echo ($arrData["banner"]); ?>" style="width:1100px;height:300px;" id="banner_see">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <?php if($arrData["abid"] == 3): ?><script id="editor" type="text/plain" style="width:1100px;height:800px;">
                            <?php echo ($arrData["content"]); ?>
                        </script>
                        <?php else: ?>
                        <script id="editor" type="text/plain" style="width:900px;height:800px;">
                            <?php echo ($arrData["content"]); ?>
                        </script><?php endif; ?>
                    </div>
                </div>
        ...
        <script type="text/javascript">
            ...
            $('#btn_submit').on('click', function () {
                ...
                if(data.title==""||data.introduce==""||data.banner_position==""){
                    layer.msg('请把资料填完整', {icon: 7, time: 2000});
                    return false;
                }

                $.post("/index.php/Admin/About/editContent?abid="+data.abid, data, function (ret) {
                    if (ret == 'true') {
