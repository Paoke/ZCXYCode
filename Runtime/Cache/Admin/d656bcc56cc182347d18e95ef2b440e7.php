    ...
    <body>
        <article class="page-container">
            <form class="form form-horizontal" id="form-article-add">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-5">
                        <input type="text" class="input-text" value="" placeholder="" id="speaker" name="speaker">
                    </div>
                </div>
                <div class="row cl">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-5">
                        <input type="text" class="input-text" value="" placeholder="" id="position" name="position"><span class="c-red">(例如：广州)</span>
                    </div>
                </div>
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-5">
                        <input type="file" class="thumbimg" name="thumbimg" onchange="upload('thumbimg')"/><span class="c-red" id="thumbimg_success">(图片规格：320*216)</span>
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <script id="editor" type="text/plain" style="width:748px;height:800px;"></script>
                    </div>
                </div>
                <div class="row cl">
        ...
        <script type="text/javascript">
            ...
            $('#btn_submit').on('click', function () {
                ...
                $.post('/index.php/Admin/Case/addArticle', data, function (ret) {
                    if (ret == 'true') {
