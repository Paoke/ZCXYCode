    ...
    <body>
            ...
            <form class="form form-horizontal" id="form-article-add">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <script id="editor" type="text/plain" style="width:1100px;height:800px;">
        ...
        <script type="text/javascript">
            ...
            $('#btn_submit').on('click', function () {
                ...
                $.post("/index.php/Admin/About/contentEdit?abid="+abid, data, function (ret) {
                    if (ret == '1') {
                        layer.msg('上传成功', {icon: 7, time: 2000});
