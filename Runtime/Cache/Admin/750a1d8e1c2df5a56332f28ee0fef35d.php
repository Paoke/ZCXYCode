...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 优秀学员 <span
...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><a class="btn btn-primary radius" data-title="添加成员" href="javascript:;"
                                                               onclick="member_add('添加成员', '/index.php/Admin/Student/addMember', '780', '600')"><i class="Hui-iconfont">
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            <?php if(is_array($arrData)): foreach($arrData as $k=>$vo): ?><tr class="text-c">
                <td><?php echo ($vo["stid"]); ?></td>
                <td><?php echo ($vo["name"]); ?></td>
                <td><?php echo ($vo["job"]); ?></td>
                <td>
                    <img src="/Upload/<?php echo ($vo["header"]); ?>" width="70" height="70">
                </td>
                ...
                <td class="f-14 td-manage">
                    ...
                    <?php if($vo["status"] == 1): ?><a style="text-decoration:none"
                       onClick="member_stop(this,'<?php echo ($vo["stid"]); ?>','0')" href="javascript:;"title="下架">
                        <i class="Hui-iconfont">&#xe6de;</i>
                    </a><?php else: ?>
                    <a style="text-decoration:none"
                       onClick="member_start(this,'<?php echo ($vo["stid"]); ?>','1')" href="javascript:;" title="发布">
                        <i class="Hui-iconfont">&#xe603;</i>
                    </a><?php endif; ?>
                    <a style="text-decoration:none" class="ml-5" 
                       onClick="member_edit('编辑资料', '/index.php/Admin/Student/editMember?stid=<?php echo ($vo["stid"]); ?>', '780', '600')"  href="javascript:;" title="编辑">
                        <i class="Hui-iconfont">&#xe6df;</i>
                    </a>
                    <a style="text-decoration:none" class="ml-5"
                       onClick="member_del(this,'<?php echo ($vo["stid"]); ?>')" href="javascript:;" title="删除">
                        <i class="Hui-iconfont">&#xe6e2;</i>
                    </a>
                    <a style="text-decoration:none" class="ml-5"
                       onClick="order(this,'MoveUp','<?php echo ($vo["stid"]); ?>')" href="javascript:;" title="上移">
                        <i class="Hui-iconfont">&#xe679;</i>
                    </a>
                    <a style="text-decoration:none" class="ml-5"
                       onClick="order(this,'MoveDown','<?php echo ($vo["stid"]); ?>')" href="javascript:;" title="下移">
                        <i class="Hui-iconfont">&#xe674;</i>
                    </a>
                </td>
...
<script type="text/javascript">
    ...
    function member_del(obj, id) {
        layer.confirm('确认要删除吗？', function (index) {
            $.post('/index.php/Admin/Student/delMember?stid='+id, function (ret) {
                if (ret == 'true') {
    ...
    function member_stop(obj, id ,status) {
        layer.confirm('确认要下架吗？', function (index) {
            ...
            $.post('/index.php/Admin/Student/startStopMember?stid='+id+'&status='+status , function (ret) {
                if (ret == 'true') {
