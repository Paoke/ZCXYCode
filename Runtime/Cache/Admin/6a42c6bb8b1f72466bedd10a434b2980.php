...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 基本设置 <span
        class="c-gray en">&gt;</span> 首页Banner图列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px"
                                              href="javascript:location.replace(location.href);" title="刷新"><i class="Hui-iconfont">
    &#xe68f;</i></a></nav>
<div class="page-container">
    
    <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><a class="btn btn-primary radius" data-title="添加图片" href="javascript:;"
                                                               onclick="member_add('添加图片', '/index.php/Admin/Basic/addBanner', '780', '600')"><i class="Hui-iconfont">
        &#xe600;</i> 添加图片</a></span> <span class="r">共有数据：<strong><?php echo ($size); ?></strong> 条</span></div>
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            <?php if(is_array($arrData)): foreach($arrData as $k=>$vo): ?><tr class="text-c">
                <td><?php echo ($vo["baid"]); ?></td>
                <td>
                    <a title="预览" href="javascript:;" onclick="pic_see('图片预览', '/index.php/Admin/Basic/viewPic?img=<?php echo ($vo["img"]); ?>', '4', '780', '550')" class="ml-5" style="text-decoration:none"><i
                ...
                <td class="f-14 td-manage">
                    ...
                    <?php if($vo["status"] == 1): ?><a style="text-decoration:none"
                       onClick="member_stop(this,'<?php echo ($vo["baid"]); ?>','0')" href="javascript:;"title="下架">
                        <i class="Hui-iconfont">&#xe6de;</i>
                    </a><?php else: ?>
                    <a style="text-decoration:none"
                       onClick="member_start(this,'<?php echo ($vo["baid"]); ?>','1')" href="javascript:;" title="发布">
                        <i class="Hui-iconfont">&#xe603;</i>
                    </a><?php endif; ?>

                    <a style="text-decoration:none" class="ml-5"
                       onClick="member_del(this,'<?php echo ($vo["baid"]); ?>')" href="javascript:;" title="删除">
                        <i class="Hui-iconfont">&#xe6e2;</i>
                    </a>
                    <a style="text-decoration:none" class="ml-5"
                       onClick="order(this,'MoveUp','<?php echo ($vo["baid"]); ?>')" href="javascript:;" title="上移">
                        <i class="Hui-iconfont">&#xe679;</i>
                    </a>
                    <a style="text-decoration:none" class="ml-5"
                       onClick="order(this,'MoveDown','<?php echo ($vo["baid"]); ?>')" href="javascript:;" title="下移">
                        <i class="Hui-iconfont">&#xe674;</i>
                    </a>
                </td>
...
<script type="text/javascript">
    ...
    function member_del(obj, id) {
        layer.confirm('确认要删除吗？', function (index) {
            $.post('/index.php/Admin/Basic/delMember?baid='+id, function (ret) {
                if (ret == 'true') {
    ...
    function member_stop(obj, id ,status) {
        layer.confirm('确认要下架吗？', function (index) {
            ...
            $.post('/index.php/Admin/Basic/startStopMember?baid='+id+'&status='+status , function (ret) {
                if (ret == 'true') {
    ...
    function order(t,oper,id){
        ...
        if(oper=="MoveUp"){    //向上移动
            if($(data_tr).prev().html()==null){ //获取tr的前一个相同等级的元素是否为空
                ...
                $.post('/index.php/Admin/Basic/orderMember?baid='+id+'&pnid='+previd, function (ret) {
                    if (ret == 'true') {
            ...
            if($(data_tr).next().html()==null){
                ...
                $.post('/index.php/Admin/Basic/orderMember?baid='+id+'&pnid='+nextid, function (ret) {
                    if (ret == 'true') {
