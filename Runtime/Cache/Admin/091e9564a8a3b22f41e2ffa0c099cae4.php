    ...
    <body>
        <article class="page-container">
            <form action="" method="post" class="form form-horizontal" id="form-member-add">
                <input type="hidden" id="teid" name="teid" value="<?php echo ($arrData["teid"]); ?>">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="file" class="header" name="header" onchange="upload('header')"><span class="c-red" id="header_success">(图片规格：204*204)</span>
        ...
        <script>
            $('#btn_submit').on('click', function () {
                ...
                $.post('/index.php/Admin/Teacher/editMember?teid='+data.teid, data, function (ret) {
                    if (ret == 'true') {
