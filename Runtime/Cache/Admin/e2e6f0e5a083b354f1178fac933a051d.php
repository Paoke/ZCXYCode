    ...
    <body>
            ...
            <form action="" method="post" class="form form-horizontal" id="form-member-add">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="file" class="img" name="img" onchange="upload('img')"><span class="c-red" id="img_success">(图片规格：1920*650)</span>
                        <br/><br/><img src="" id="img_see" width="500" height="200">
        ...
        <script>
            $('#btn_submit').on('click', function () {
                ...
                $.post('/index.php/Admin/Basic/addBanner', data, function (ret) {
                    if (ret == 'true') {
