...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 基本设置 <span
        class="c-gray en">&gt;</span> 栏目文字设置 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px"
            ...
            <?php if(is_array($arrData)): foreach($arrData as $k=>$vo): ?><tr class="text-c">
                ...
                <td class="f-14 td-manage">
                    <a style="text-decoration:none" class="ml-5"
                       onClick="member_edit('编辑资料', '/index.php/Admin/Basic/editWord?woid=<?php echo ($vo["woid"]); ?>', '780', '600')"  href="javascript:;" title="编辑">
